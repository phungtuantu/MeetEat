...
<div class="card">
    <div class="row">
        <h4>Evaluate your order</h4>
        <div class=""> <img src="https://i.imgur.com/xELPaag.jpg" width="70" class="rounded-circle mt-2"> </div>
        <div class="col-10">
...
<script>
export default {
  name: "EvaluateMeal" //même nom que le nom de fichier
}
</script>
